          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Minimal Data Collection</h4>
                ...
                <div>
                  <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Analytics</h4>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-slate-700 dark:text-slate-300">
                  ...
                  <a href="mailto:privacy@thetruthinislam.org" className="text-emerald-600 hover:text-emerald-700 dark:text-emerald-400">
