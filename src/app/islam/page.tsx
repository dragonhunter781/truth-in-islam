      ...
      <section className="relative overflow-hidden bg-slate-900 py-24 text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link href="/pillars">
              <Button size="lg" className="bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-500 hover:to-amber-500 text-white">
      ...
      <section className="py-24 bg-slate-800">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg mx-auto dark:prose-invert">
            ...
            <div className="my-12 rounded-2xl bg-slate-900/50 p-8 border border-slate-700">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {sections.map((section) => (
              <Link key={section.href} href={section.href}>
                <div className="group h-full rounded-2xl border border-slate-700 bg-slate-800/50 p-6 transition-all hover:border-amber-500/30 hover:shadow-lg">
