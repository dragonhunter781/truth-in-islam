            ...
            <Card className="overflow-hidden rounded-xl border border-slate-700 bg-slate-800/50">
              ...
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  <p className="text-2xl font-arabic text-white mb-4" dir="rtl">
            ...
            <Card className="mt-6">
              <CardContent className="p-6">
                ...
                <p className="mt-4 text-sm text-slate-400">
                  Learn more about the differences between Islam and Christianity on our <Link href="/blog" className="text-amber-400 hover:underline">blog</Link> and <Link href="/quran" className="text-amber-400 hover:underline">Quran analysis</Link> pages.
                </p>
              </CardContent>
            </Card>
          </motion.div>
