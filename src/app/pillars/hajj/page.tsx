        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-4">
              <Card className="border-amber-200 dark:border-amber-800">
                <CardHeader>
                  <CardTitle className="text-lg text-amber-700 dark:text-amber-400">The Kaaba Was a Pagan Shrine</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-slate-700 dark:text-slate-300 mb-4">
              ...
              <Card className="border-amber-200 dark:border-amber-800">
                <CardHeader>
                  <CardTitle className="text-lg text-amber-700 dark:text-amber-400">Rituals Borrowed from Paganism</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-amber-200 dark:border-amber-800">
                <CardHeader>
                  <CardTitle className="text-lg text-amber-700 dark:text-amber-400">The Black Stone</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-slate-700 dark:text-slate-300 mb-4">
              ...
              {[
                ...
                <Card key={index}>
                  <CardContent className="p-4">
                    <h3 className="font-bold text-emerald-600 dark:text-emerald-400">{item.day}</h3>
                    <p className="text-sm text-slate-600 dark:text-slate-400">{item.ritual}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
          ...
          >
            ...
            <div className="space-y-4">
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Deaths and Stampedes</h3>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Exclusivity</h3>
                  <p className="text-slate-600 dark:text-slate-400">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Commercialization</h3>
                  <p className="text-slate-600 dark:text-slate-400">
            ...
            <div className="space-y-4">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-emerald-600 dark:text-emerald-400">— Quran 3:97</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-emerald-600 dark:text-emerald-400">— Quran 2:158</p>
